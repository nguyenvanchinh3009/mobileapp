...
import { askGPT } from '../../services/chatApis'; // Đã đổi tên hàm từ askGemini sang askGPT
...
export default function ChatScreen() {
    ...
    const handleSend = async () => {
        ...
        const botMsg = { id: (Date.now() + 1).toString(), text: botReply, sender: 'bot' as const };
    ...
    return (
        <View style={styles.container}>
            ...
            {loading && <ActivityIndicator color="#0000ff" style={{ marginBottom: 10 }} />}
...
const styles = StyleSheet.create({
    ...
    userText: { color: '#fff' }, 
    inputContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 20, borderTopWidth: 1, borderColor: '#eee', paddingTop: 10 },
